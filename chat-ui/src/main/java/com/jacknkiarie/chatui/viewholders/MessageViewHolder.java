package com.jacknkiarie.chatui.viewholders;
...
//    }
    ...
    public void setBackground(int messageType) {
        ...
        int chatMessageBackground = ContextCompat.getColor(context, androidx.cardview.R.color.cardview_light_background);
        int bubbleBackground = ContextCompat.getColor(context, androidx.cardview.R.color.cardview_light_background);
